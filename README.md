#[SARAH-Plugin-myFox](http://blog.hotfirenet.com/sarah/plugin-myfox-sarah/)
...
Plugin [myFox] Pour SARAH. Vous pouvez depuis SARAH contrôler votre centrale d'alarme myfox grace à l'API officielle. 
